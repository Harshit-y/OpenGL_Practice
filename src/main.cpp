...
GLfloat vertices[] =
{ //               COORDINATES                  /     COLORS           //
	-0.5f, -0.5f * float(sqrt(3)) * 1 / 3, 0.0f,     0.0f, 1.0f,  0.00f, // Lower left corner
	...
	-0.25f, 0.5f * float(sqrt(3)) * 1 / 6, 0.0f,     0.5f, 0.5f,  0.0f, // Inner left
	 0.25f, 0.5f * float(sqrt(3)) * 1 / 6, 0.0f,     0.5f, 0.0f,  0.5f, // Inner right
	 0.0f, -0.5f * float(sqrt(3)) * 1 / 3, 0.0f,     0.0f, 0.5f,  0.5f  // Inner down
};
...
int main() {
    ...
    //Links VBO to VAO
    VAO1.LinkAtrrib(VBO1, 0, 3, GL_FLOAT, 6*(sizeof(GLfloat)), (void*)0);
    VAO1.LinkAtrrib(VBO1, 1, 3, GL_FLOAT, 6*(sizeof(GLfloat)), (void*)(3 * sizeof(GLfloat)));
